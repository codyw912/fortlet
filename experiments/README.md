...
- `0051-firewall-cleared-nix-provider-rehearsal.md` — declared; one explicitly authorized fresh successor will repeat the frozen provider unit with network approval from the outset.
