...
- `0035-workspace-cargo-codex-loop.md` — declared; one successor will test a guest-distinct Cargo target inside Codex's writable project workspace without overrides or retries.
