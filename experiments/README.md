...
- `0049-pinned-runtime-nix-provider-rehearsal.md` — declared; the authorized successor adds byte-verified runtime and firmware selectors to the proven absolute isolated-root controls.
