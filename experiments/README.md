...
- `0053-package-lifecycle-base-rehearsal.md` — declared; one base-only unit will exercise the corrected production script while a preseeded harness marker prevents harness, provider, or model work.
