...
- `0019-output-backed-project-provisioning.md` — declared; one bounded unit will test transient Rust extraction on the host-backed output mount, then verify the published layer and focused Rust test.
