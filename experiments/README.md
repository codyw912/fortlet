...
- `0056-trusted-host-canonical-seal.md` — declared; test mirrored guest validation followed by exact host write-bit removal and strict versus relaxed read-only consumers.
