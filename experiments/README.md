...
- `0054-nix-runtime-substrate-feasibility.md` — declared; compare the accepted Node/Debian mechanism with the Nix-built OCI, isolated project store, and pinned Tact closure under fixed credential-free cold, warm, and lifecycle conditions.
