...
- `0060-root-ca-bundle-lifecycle.md` — accepted; a real disposable-root CA bundle passed manifest-free boot and stop/start controls, then fresh schema-1 preparation passed in 155.00 seconds with a 0.00-second warm median and sub-second absent, stopped, and running lifecycle medians.
