...
- `0059-bounded-schema-one-lifecycle.md` — declared; the exact signed bounded-reuse implementation must pass five unchanged sub-second prepares before the fixed absent, stopped, and running lifecycle campaign may proceed.
