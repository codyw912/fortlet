...
- `0019-output-backed-project-provisioning.md` — rejected; output-backed extraction cleared the capacity failure, but validation rejected an absolute symlink installed by the Rust distribution before publication.
