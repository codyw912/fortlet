...
- `0023-codex-bearer-projection-confirmation.md` — declared; one fresh bounded session will confirm the repaired bearer placeholder and ordinary edit/test loop.
