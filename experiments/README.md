...
- `0052-ca-corrected-nix-provider-rehearsal.md` — declared; one authorized fresh successor will validate the corrected and fully gated common base against the frozen public Nix-provider unit.
