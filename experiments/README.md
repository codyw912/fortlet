...
- `0028-managed-noninteractive-codex-successor.md` — declared; one immutable-package prompt will test visible managed non-interactive Codex response, clean exit, Apps silence, and public cleanup without retry.
