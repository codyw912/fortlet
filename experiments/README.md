...
- `0045-built-startup-phase-attribution.md` — declared; repeats phase attribution only after proving the exact rebuilt product executable emits bounded timing events.
