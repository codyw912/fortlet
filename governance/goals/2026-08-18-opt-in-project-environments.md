...
Archived after PR #4 squash-merged as
...
The bounded FIP-0005 publication completed through PR #4. Hosted Rust
verification passed, the operator squash-merged it, landing verification found
an empty reviewed-tip-to-`main` diff, and the declared local and remote
bookmarks were removed. This goal is complete.
